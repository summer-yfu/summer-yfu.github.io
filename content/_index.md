  ...
  - block: markdown
    content:
      ...
      text: |-
        ...
        I apply a range of methods in deep learning (specific focus on graph neural network and reinforcement learning) to investigate problems in Boolean Satisfiability and Planning. 

        Recently I've been working on building AI agents, investigating and evaluating on their performance, under the supervision of Professor Flora Salim.
